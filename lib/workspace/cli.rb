  ...
  class CLI
    ...
    def cmd_config(args)
      ...
      parser = OptionParser.new do |opts|
        ...
        opts.separator "  claude:"
        opts.separator "    mcp_servers:                 MCP servers passed to claude (--mcp-servers)"
        opts.separator "                                 Example: [atlassian-mcp, playwright, sentry]"
        ...
        opts.separator "  claude:"
        opts.separator "    mcp_servers:                 MCP servers for this project (overrides global)"
        opts.separator ""
        opts.separator "Examples:"
